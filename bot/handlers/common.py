...
async def show_help(message: Message):
    ...
    text = (
        ...
        f"🆔 <b>Sizning Telegram chat ID raqamingiz:</b> <code>{chat_id}</code> <i>(nusxa olish uchun bosing)</i>\n"
        f"👤 <b>Talabgor:</b> {full_name}\n\n"
        ...
        "Agar siz o'quvchilaringiz uchun milliy sertifikat formatida yangi test javoblarini yaratish, "
        "kod orqali test o'tkazish hamda barcha natijalar statistikasini olishni istasangiz, "
        "botda <b>Admin huquqi</b> talab qilinadi.\n\n"
        "👨‍💻 <b>SHAXSIY YORDAM VA ADMIN BILAN BOG'LANISH:</b>\n"
        f"👉 <b>Bosh admin:</b> @ITCenter_01\n"
        f"💡 <i>(Adminga murojaat qilganda o'z Chat ID raqamingizni yuboring: <code>{chat_id}</code>)</i>"
    )
